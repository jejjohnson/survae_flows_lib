...
class PlaneDataset(Dataset):
    def __init__(self, num_points, flip_axes=False, **kwargs):
...
class TwoMoonsDataset(PlaneDataset):
    ...
    def _create_data(self):
        data = make_moons(n_samples=self.num_points, noise=self.kwargs.get("noise", 0.1), random_state=self.kwargs.get("seed", 123))[0]

...
transforms = [
    ...
    Conv1x1Householder(4, 4),
    # (4,7,7) -> (98,)
    Reshape((4, 7, 7), (np.prod((4, 7, 7)),)),
    GaussianMixtureCDF((196,), num_mixtures=num_mixtures),
    InverseGaussCDF(),
    FastHouseholder(196, 10),
    GaussianMixtureCDF((196,), num_mixtures=num_mixtures),
    InverseGaussCDF(),
    FastHouseholder(196, 10),
    GaussianMixtureCDF((196,), num_mixtures=num_mixtures),
...
# base distribution
base_dist = StandardNormal((np.prod((4, 7, 7)),))
